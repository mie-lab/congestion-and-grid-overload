...
# Revenue
pt["revenue"][order].loc[scenarios].plot.bar(
    ax=ax[0], linewidth=1, edgecolor="w", color=colors, width=bar_width, legend=False
)
ax[0].fill_between([-1, 5], 0, pt["revenue"]["Optimal"]["I"], facecolor="grey", alpha=0.25, label="Optimal")
lgd = ax[0].legend(bbox_to_anchor=(0.0, 1.1, 1.0, 0.102), loc=3, ncol=3, mode="expand", borderaxespad=0.0, fontsize=9)
ax[0].set_ylim(5600, 6300)
ax[0].set_ylabel("Revenue ($)")

# Energy Cost
pt["energy_cost"][order].loc[scenarios].plot.bar(
    ax=ax[1], linewidth=1, edgecolor="w", color=colors, width=bar_width, legend=False
)
...
# Demand Charge
pt["demand_charge"][order].loc[scenarios].plot.bar(
    ax=ax[2], linewidth=1, edgecolor="w", color=colors, width=bar_width, legend=False
)
...
# Profit
pt["profit"][order].loc[scenarios].plot.bar(
    ax=ax[3], linewidth=1, edgecolor="w", color=colors, width=bar_width, legend=False
)
