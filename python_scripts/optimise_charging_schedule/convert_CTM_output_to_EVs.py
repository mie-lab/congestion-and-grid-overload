...
event_queue, charging_nw = process_CTM_arrivals_file(config.path_to_EV_arrivals_file, config.SECONDS_OFFSET_MIDNIGHT)
...
#
level1_unctrl_100 = run_experiment(charging_nw, uncontrolled, deepcopy(event_queue))
...
#
# level2_200kW_llf_100 = run_experiment(charging_nw, llf, deepcopy(event_queue))
...
cost_min = adacharge.AdaptiveSchedulingAlgorithm(
    cost_min_obj, solver="MOSEK", quantize=True, reallocate=False, peak_limit=None, max_recompute=1
)
# cost_min_offline = adacharge.AdaptiveChargingAlgorithmOffline(cost_min_obj, solver="MOSEK")
# adacharge.AdaptiveChargingAlgorithmOffline
#
# level2_200kW_cost_min_100 = run_experiment(charging_nw, cost_min, deepcopy(event_queue))
# level2_200kW_cost_min_100_offline = run_experiment(charging_nw, cost_min_offline, deepcopy(event_queue))
...
evs_100 = pd.DataFrame(
    {
        "Level 1: Unctrl: 200 kW : CTM # EVSEs": level1_unctrl_100,
        "Level 2: LLF: 200 kW : CTM # EVSEs": level2_200kW_llf_100,
        "Level 2: Min Cost: 200 kW : CTM # EVSEs": level2_200kW_cost_min_100,
        "Level 2: Min Cost: 200 kW : CTM # EVSEs": level2_200kW_cost_min_100_offline,
    }
)
...
evs_100.to_csv("results/CTM_EV_comparison.csv")

pd.read_csv("results/CTM_EV_comparison.csv", index_col=0)
#
